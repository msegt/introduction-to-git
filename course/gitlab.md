...
Systems like Git allow us to move work between any two repositories.  In practice, though, it's easiest to use one copy as a central hub, and to keep it on the web rather than on someone's laptop.  Most programmers use hosting services like [GitLab](https://GitLab.com), [BitBucket](https://bitbucket.org) or [GitLab](https://gitlab.com/) to hold those master copies. All these services provide a level of functionality for free. In the School of Computer Science & Informatics we provide our own [self hosted version of GitLab](https://gitlab.cs.cf.ac.uk), available at [https://gitlab.cs.cf.ac.uk](https://gitlab.cs.cf.ac.uk).
...
You can now use Git locally to track, view and restore changes to files, and push your changes to a remote repository so that you can have your work stored in a second location, enable collaboration, and easily share work between different machines.
